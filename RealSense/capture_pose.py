...
print("Press Enter to capture object.")
while True:
    cv2.namedWindow('Press Enter to start capture', cv2.WINDOW_AUTOSIZE)
    cv2.imshow('Press Enter to start capture', np.zeros((100, 300), np.uint8))
    if cv2.waitKey(1) == 13:
        break
...
image_path = './input/rgb/00000000.png'
